...
const boutonPartie = document.getElementById('boutonPartie');
boutonPartie.addEventListener('click', (event) => {
  event.preventDefault();
  window.location.href = '/room'; // remplacer avec le lien de la page de modification du profil
});